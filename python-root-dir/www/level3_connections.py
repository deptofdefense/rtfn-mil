#!/usr/bin/env python
'''
 * FILENAME: level3_connections.py
 * PURPOSE: Allow the use of python virtual environment through a webserver call. 
            Allows a query of current Level3/CenturyLink connections.
...
print(L3_io.queryConnectionsByAccountJSON(0,"")) #TODO: update with variable for account
