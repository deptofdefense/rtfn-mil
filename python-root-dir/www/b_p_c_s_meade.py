#!/usr/bin/env python
'''
 * FILENAME: b_p_c_s_meade.py
 * PURPOSE: Allow the use of python virtual environment through a webserver call. 
            Provide Fort Meade endpoint capabilities through Level3/CenturyLink.
...
#get the Fort Meade Base Post Camp Staton endpoint capabilities
